...
export default function ManageTeachers() {
  ...
  return (
    <React.Fragment>
       <Overview header="Teachers" overviewInfo={dashboardOverview} overviewClass="flex-wrap md:flex-nowrap">
        ...
        >
            <Form
                ...
                <Form.Item<FieldType>
                    ...
                    name="first_name"
                    rules={[{ required: true, message: 'Please input teacher first name!' }]}
                >
                ...
                <Form.Item<FieldType>
                    ...
                    name="last_name"
                    rules={[{ required: true, message: 'Please input teacher last name!' }]}
                >
                    <Input className="custom-input" />
                </Form.Item>
                ...
                <Form.Item<FieldType>
                    label="Date of Birth"
                    name="dob"
                    rules={[{ required: true, message: 'Please teacher date of birth' }]}
                >
